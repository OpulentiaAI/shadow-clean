...
exports.streamChatWithTools = (0, server_1.action)({
    ...
    handler: async (ctx, args) => {
        ...
        console.log(`[STREAMING] API keys present - anthropic: ${!!args.apiKeys?.anthropic}, openai: ${!!args.apiKeys?.openai}, openrouter: ${!!args.apiKeys?.openrouter}, exa: ${!!args.apiKeys?.exa}`);
            ...
            for (let round = 0; round < MAX_AGENT_STEPS; round++) {
                ...
                for await (const part of result.fullStream) {
                    ...
                    if (partType === "tool-input-start" ||
                        ...
                        console.log(`[STREAMING] TOOL STREAM PART type=${partType} payload=${JSON.stringify(part).substring(0, 500)}`);
                    }

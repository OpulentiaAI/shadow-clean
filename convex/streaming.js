...
exports.streamChatWithTools = (0, server_1.action)({
    ...
    handler: async (ctx, args) => {
        ...
        console.log(`[STREAMING] API keys present - anthropic: ${!!args.apiKeys?.anthropic}, openai: ${!!args.apiKeys?.openai}, openrouter: ${!!args.apiKeys?.openrouter}, exa: ${!!args.apiKeys?.exa}, fireworks: ${!!args.apiKeys?.fireworks}`);

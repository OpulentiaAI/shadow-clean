...
exports.createFromTemplate = exports.seedGlobalConnectors = exports.listDefaultTemplates = exports.DEFAULT_MCP_CONNECTORS = void 0;
 ...
 */
exports.DEFAULT_MCP_CONNECTORS = [
    {
        name: "Atlassian",
        nameId: "atlassian",
 ...
 */
exports.listDefaultTemplates = (0, server_1.mutation)({
    args: {},
    handler: async () => {
        return exports.DEFAULT_MCP_CONNECTORS.map((connector) => ({
            name: connector.name,
 ...
 */
exports.seedGlobalConnectors = (0, server_1.internalMutation)({
    args: {
        connectors: values_1.v.array(values_1.v.object({
            name: values_1.v.string(),
            nameId: values_1.v.string(),
            url: values_1.v.string(),
            type: values_1.v.union(values_1.v.literal("HTTP"), values_1.v.literal("SSE")),
        })),
    },
    handler: async (ctx, args) => {
        ...
        for (const connector of args.connectors) {
            ...
            const existing = await ctx.db
                .query("mcpConnectors")
                .withIndex("by_user_name_id", (q) => q.eq("userId", undefined).eq("nameId", connector.nameId))
                .unique();
            if (existing) {
 ...
 */
exports.createFromTemplate = (0, server_1.mutation)({
    args: {
        userId: values_1.v.id("users"),
        templateNameId: values_1.v.string(),
        url: values_1.v.string(),
    ...
    handler: async (ctx, args) => {
        // Find the template
        const template = exports.DEFAULT_MCP_CONNECTORS.find((c) => c.nameId === args.templateNameId);
        if (!template) {
        ...
        const existing = await ctx.db
            .query("mcpConnectors")
            .withIndex("by_user_name_id", (q) => q.eq("userId", args.userId).eq("nameId", template.nameId))
            .unique();
        if (existing) {
